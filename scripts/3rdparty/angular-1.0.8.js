...
function $ControllerProvider() {
  ...
  this.$get = ['$injector', '$window', function($injector, $window) {
     ...
     *
     * It's just a components call to {@link AUTO.$injector $injector}, but extracted into
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
     ...
     *
     * Here is a components scope snippet to show how you can interact with the scope.
     * <pre>
 ...
 *
 * @description
 * This is very components implementation of testing browser's features.
 */
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     * the $q service. While for components usage patterns this doesn't matter much, for advanced usage
    ...
    if (lowercase(method) == 'jsonp') {
      ...
      xhr.onreadystatechange = function() {
        if (xhr.readyState == 4) {
          ...
          // CORS "components response headers" http://www.w3.org/TR/cors/
          var value,
 ...
 *     property of the object. That's equivalent to the components substring match with a `string`
 *     as described above.
 *
 ...
 *
 * @example
 * Here is a components form for editing user contact information. Adding, removing, clearing, and
 ...
 *
 * @example
 * In this example there are two location where a components binding (`{{}}`) is present, but the one
    ...
    <doc:example>
      <doc:source>
        ...
        <div ng-controller="Ctrl">
          ...
          <!--- Example with components pluralization rules for en locale --->
          Without Offset:
          <ng-pluralize count="personCount"
                        when="{'0': 'Nobody is viewing.',
                               'one': '1 person is viewing.',
 ...
 * including the rendered template of the current route into the main pages (`index.html`) file.
